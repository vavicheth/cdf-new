...
export declare type DefaultToolbarItemType = 'pager' | 'layout-config' | 'pan' | 'zoom-out' | 'zoom-in' | 'zoom-mode' | 'marquee-zoom' | 'spacer' | 'text' | 'annotate' | 'responsive-group' | 'ink' | 'image' | 'line' | 'arrow' | 'rectangle' | 'ellipse' | 'polygon' | 'polyline' | 'note' | 'print' | 'search' | 'debug' | 'sidebar-thumbnails' | 'signature' | 'comment' | 'sidebar-document-outline' | 'sidebar-annotations' | 'sidebar-bookmarks' | 'highlighter' | 'text-highlighter' | 'ink-eraser' | 'stamp' | 'document-editor' | 'export-pdf';
